...
// Note: libfaiss_go_ext comes after libfaiss because it uses FAISS C++ classes for HNSW property accessors
#cgo darwin,amd64 LDFLAGS: -L${SRCDIR}/libs/darwin_amd64 -lfaiss_c -lfaiss -lfaiss_go_ext -L/opt/homebrew/opt/libomp/lib -lomp -Wl,-framework,Accelerate
#cgo darwin,arm64 LDFLAGS: -L${SRCDIR}/libs/darwin_arm64 -lfaiss_c -lfaiss -lfaiss_go_ext -L/opt/homebrew/opt/libomp/lib -lomp -Wl,-framework,Accelerate
