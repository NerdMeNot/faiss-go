...
/*
#cgo LDFLAGS: ${SRCDIR}/libs/darwin_amd64/libfaiss_c.a ${SRCDIR}/libs/darwin_amd64/libfaiss.a -Wl,-framework,Accelerate -L/usr/local/opt/libomp/lib -lomp -lm -lstdc++
*/
import "C"
