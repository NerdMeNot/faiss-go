...
/*
#cgo LDFLAGS: ${SRCDIR}/libs/darwin_arm64/libfaiss_c.a ${SRCDIR}/libs/darwin_arm64/libfaiss.a -Wl,-framework,Accelerate -L/opt/homebrew/opt/libomp/lib -lomp -lm -lstdc++
*/
import "C"
