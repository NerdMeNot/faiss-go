...
/*
#cgo LDFLAGS: -Wl,-force_load,${SRCDIR}/libs/darwin_arm64/libfaiss_c.a -L${SRCDIR}/libs/darwin_arm64 -lfaiss -Wl,-framework,Accelerate -L/opt/homebrew/opt/libomp/lib -L/usr/local/opt/libomp/lib -lomp -lm -lstdc++
*/
import "C"
